...
2. As you can see from the correlation plot, there seems to be high correlation between 
...
newHotel <- data.frame(area=55000, age=4, numrooms=319, OccRate=0.80)
newHotel
```

```{r}
## Predicting the energy of the new hotel
predict(finalModel, interval="predict", newdata=newHotel)
```
